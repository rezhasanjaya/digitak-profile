                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="nama_workshop" class="form-control" name="nama_workshop" placeholder="Nama Workshop" value="{{ $portofolio->nama_aplikasi }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                            ...
                                            <input type="text" id="tahun_berdiri" class="form-control" name="tahun_berdiri" placeholder="Tahun Berdiri" value="{{ $portofolio->tahun_pembuatan }}">
                                    </div>
                                </div>
                            </div>
