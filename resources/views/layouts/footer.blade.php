    ...
    <div class="row">
      ...
      <div class="col-4 ">
        ...
        <ul class="sosmed flex-column">
          <li class="sosmed-item mb-2"><a class="sosmed-link" href="#">Beranda</a></li>
          <li class="sosmed-item mb-2"><a class="sosmed-link" href="#">Tentang Kami</a></li>
          <li class="sosmed-item mb-2"><a class="sosmed-link" href="#">Portofolio</a></li>
          <li class="sosmed-item mb-2"><a class="sosmed-link" href="#">Kontak Kami</a></li>
        </ul>
      </div>
